        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    GRXX = table.Column<string>(nullable: true),
                    GRYY = table.Column<string>(nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_QuestionTypes_CompanyTypes_CompanyTypeId",
                        column: x => x.CompanyTypeId,
                        principalTable: "CompanyTypes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Visits_States_StateId",
                        column: x => x.StateId,
                        principalTable: "States",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Visits_Technicals_TechnicalId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_QuestionTypes_CompanyTypeId",
                table: "QuestionTypes",
                column: "CompanyTypeId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Visits_StateId",
                table: "Visits",
                column: "StateId");

            migrationBuilder.CreateIndex(
                name: "IX_Visits_TechnicalId",
                table: "Visits",
                column: "TechnicalId");
        }
