...
{
    public class TakePicture3PageViewModel : ViewModelBase
    {
        ...
        public TakePicture3PageViewModel(INavigationService navigationService, IApiService apiService) : base(navigationService)
        {
            _navigationService = navigationService;
            _apiService = apiService;
            Title = "Tomar Fotografía 3";
            IsEnabled = true;
            ImageSource = "nophoto";
        }
        ...
        private async void TakePicture()
        {
            ...
            if (_file != null)
            {
                ...
                visitDetailPageViewModel.ImageUrl3 = ImageSource.FromStream(() =>
                {
                    var stream = _file.GetStream();
                    return stream;
                });
                visitDetailPageViewModel.File3 = _file;
            }
            IsRunning = false;
        }
        ...
        private async void Save()
        {
            ...
            {
                var visitDetailPageViewModel = VisitDetailPageViewModel.GetInstance();
                visitDetailPageViewModel.ImageUrl3 = "noimageavailable.png";
            }
            await _navigationService.GoBackAsync();
        }
    }
