...
{
    public class TakePicture4PageViewModel : ViewModelBase
    {
        ...
        public TakePicture4PageViewModel(INavigationService navigationService, IApiService apiService) : base(navigationService)
        {
            _navigationService = navigationService;
            _apiService = apiService;
            Title = "Tomar Fotografía 4";
            IsEnabled = true;
            ImageSource = "nophoto";
        }
        ...
        private async void TakePicture()
        {
            ...
            if (_file != null)
            {
                ...
                visitDetailPageViewModel.ImageUrl4 = ImageSource.FromStream(() =>
                {
                    var stream = _file.GetStream();
                    return stream;
                });
                visitDetailPageViewModel.File4 = _file;
            }
            IsRunning = false;
        }
        ...
        private async void Save()
        {
            ...
            {
                var visitDetailPageViewModel = VisitDetailPageViewModel.GetInstance();
                visitDetailPageViewModel.ImageUrl4 = "noimageavailable.png";
            }
            await _navigationService.GoBackAsync();
        }
    }
