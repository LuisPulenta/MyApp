...
{
    public class TakePicture2PageViewModel : ViewModelBase
    {
        ...
        public TakePicture2PageViewModel(INavigationService navigationService, IApiService apiService) : base(navigationService)
        {
            _navigationService = navigationService;
            _apiService = apiService;
            Title = "Tomar Fotografía 2";
            IsEnabled = true;
            ImageSource = "nophoto";
        }
        ...
        private async void TakePicture()
        {
            ...
            if (_file != null)
            {
                ...
                visitDetailPageViewModel.ImageUrl2 = ImageSource.FromStream(() =>
                {
                    var stream = _file.GetStream();
                    return stream;
                });
                visitDetailPageViewModel.File2 = _file;
            }
            IsRunning = false;
        }
        ...
        private async void Save()
        {
            ...
            {
                var visitDetailPageViewModel = VisitDetailPageViewModel.GetInstance();
                visitDetailPageViewModel.ImageUrl2 = "noimageavailable.png";
            }
            await _navigationService.GoBackAsync();
        }
    }
